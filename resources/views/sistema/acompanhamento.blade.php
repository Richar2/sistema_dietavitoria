        ...
        <div class="panel-body">
            <div style="width:100%;position:relative;float:left">
                ...
                <div class="form-group" style="width:640px;float:left;margin-right:20px">
                    ...
                    <input class="form-control" type="text" name="Nome" id="Nome" value="" disabled />
                </div>
            </div>
        ...
        <div class="panel-body">
            ...
            <div style="width:100%;position:relative;float:left">
                ...
                <div class="form-group" style="width:620px;float:left">
                    ...
                    <input class="form-control" type="text" name="imc" id="inputIMC" class="imc" value="" disabled/>
                </div>
            </div>
        ...
        <div class="panel panel-info" style="margin-bottom:20px" id="hist_">
            <div class="panel-body">
                ...
                <div style="width:100%;position:relative;float:left">
                    <div class="form-group" style="width:140px;float:left;margin-right:20px">
                        <label for="Coxa">Coxas</label>
                        <input class="form-control" type="text" name="CoxaHistorico" class="Coxa" value=") > 0 ? sprintf('%01.2f',$historico->coxa) : "" " disabled/>
                    </div>

                    <div class="form-group" style="width:300px;float:left;margin-right:20px">
                        <label for="Peso">+/-</label>
                        <input class="form-control" type="text" name="diffCoxaHistorico" class="diffCoxa" value=" > 0 ? sprintf('%+01.2f',$historico->diffcoxa) : ""disabled/>
                    </div>
                    ...
                    <div class="bs-example" data-example-id="glyphicons-accessibility">
                        ...
                        <div class="alert alert-" role="alert">
                          ...
                          <div style="clear:both;height:10px"></div>  
                            ...
                            <span><img class="star " src="img/shirt.png" height="16" width="16" border="0" style="border:none;" title="Alcançou a meta" /></span>&nbsp;Parabéns! A meta foi alcançada.<div style="clear:both;height:5px"></div>     
                         
                          silver_medal                    
                            <span><img class="silver_medal " src="img/medal-silver-3-icon.png" width="16" height="16" border="0" title="Alcançou metade da meta" style="border:none;" /></span>&nbsp;Parabéns! Metade da meta foi alcançada.<div style="clear:both;height:5px"></div>     
                         
                          gold_medal == 1):
                            <span><img class="gold_medal  " src="img/medal-gold-3-icon.png" height="16" title="Manteve meta por 6 semanas" width="16" border="0" style="border:none" /></span>&nbsp;Parabéns! A meta foi mantida por 6 semanas.
