...
class CreateAlunoTable extends Migration {
	...
	public function up()
	{
		Schema::create('aluno', function(Blueprint $table)
		{
			...
			$table->integer('TurmaId')->nullable();
			...
			$table->integer('ClinicoId')->nullable();
			$table->boolean('hasCompulsao', 1)->nullable();
			$table->boolean('hasVicio', 1)->nullable();
			$table->integer('VicioId')->nullable();
			$table->integer('ConsistenciaFecalId')->nullable();
			$table->integer('TipoCompulsaoId')->nullable();
			$table->integer('FamiliaId')->nullable();
